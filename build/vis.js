...
var cnnvis = (function(exports){
  ...
  // same as graph but draws multiple lines. For now I'm lazy and duplicating the code, but in future I will merge these two more nicely.
  // 和图一样，这里可以画多条线。现在我比较懒，并且重复代码，但是将来我将把这两个合并得更好。
