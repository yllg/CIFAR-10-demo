...
(function(global) {
  ...
  // Volume utilities
  // 数据增强训练，偏移量训练，反转训练
  // crop is the size of output ; crop是数据输出大小
  // dx,dy are offset wrt incoming volume, of the shift; 位移的偏移量
  // fliplr is boolean on whether we also want to flip left<->right 是否左右反转
  var augment = function(V, crop, dx, dy, fliplr) {
    ...
    // randomly sample a crop in the input volume 在输入卷中随机取样
    // 复制数据
    var W;
